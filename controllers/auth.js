  ...
  client
    ...
    .then((data) => {
      ...
      if (isValid.length !== 0) {
        ...
        //IF THE CONDITION IS FALSE THAT IS THE USER DOES NOT EXIST ALREADY IN  DB, WE NEED TO SAVE HIS DATA TO DB FOR THAT FIRST WE HASH THE PLAIN PASSWORD GIVEN BY USER
